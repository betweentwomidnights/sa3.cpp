...
| file | size | purpose |
|---|---:|---|
| `stable-audio-3-small-sfx-base-dit-0.5B-v1.0-Q4_K_M.gguf` | 302 MB | smallest, and the fastest to train on |
| `stable-audio-3-small-sfx-base-dit-0.5B-v1.0-F16.gguf` | 877 MB | the reference training base |
| `stable-audio-3-small-sfx-base-dit-0.5B-v1.0-F32.gguf` | 1751 MB | CPU/reference validation |
...
```bash
python tools/download_models.py --variant small-sfx --encoding q4_k_m --training-base
build-cuda/bin/sa3-train --model small-sfx --models-dir models \
  --dit models/stable-audio-3-small-sfx-base-dit-0.5B-v1.0-Q4_K_M.gguf \
...
- Conversion: `tools/convert_dit.py --variant small-sfx --training-base`, then
